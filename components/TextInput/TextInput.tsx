...
const TextInput = forwardRef(
  (
    ...
    const animatedContainerStyles = useAnimatedStyle(() => {
      return {
        borderColor: interpolateColor(focusedValue.value, [0, 1], ['#ffffff00', theme.colors.border]),
      };
    });
    ...
    return (
      <View style={{width: '100%', flexShrink: 0.5 }}>
        <Pressable
          onPress={() => {
            inputRef?.current?.focus();
          }}
          ...
          disabled={disabled}
        >
          <Animated.View style={[styles.itemContainer, animatedContainerStyles, containerStyle]}>
